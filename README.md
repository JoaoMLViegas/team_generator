...
A terminal-based Python program for generating balanced teams from stored or input player lists. The app includes a menu interface that allows users to add, remove, edit, and view players or teams and to export or copy teams.
...
- Rating Editing: Update an existing player's rating without removing and recreating the player.
- Team Export: Save generated lineups to .txt files with automatic folder management and filename sanitisation.
- Clipboard Copy: Copy generated team lineups directly to the system clipboard.
...
After teams are generated, you can copy the lineup to the clipboard and/or export it to a text file.
...
4. Edit player rating: Find a stored player by name and update their rating while keeping the roster sorted.
